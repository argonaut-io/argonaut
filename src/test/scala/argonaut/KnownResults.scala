...
object KnownResults extends DataTables {
  def validResultPairings =
    ...
    """[]"""                                                      ! jEmptyArray                                                                                                           |
    """{}"""                                                      ! jEmptyObject                                                                                                          |
    """[10]"""                                                    ! jSingleArray(jNumber(JsonNumberDouble(10)))                                                                                       |
    """ [ 10 ] """                                                ! jSingleArray(jNumber(JsonNumberDouble(10)))                                                                                       |
    """{"number":20}"""                                           ! jSingleObject("number", jNumber(JsonNumberDouble(20)))                                                                            |
    """{"firstKey":100,"secondKey":"secondValue"}"""              ! ("secondKey", jString("secondValue")) ->: ("firstKey", jNumber(JsonNumberDouble(100))) ->: jEmptyObject                           |
    """{ "firstKey" : 100 , "secondKey" : "secondValue" }"""      ! ("secondKey", jString("secondValue")) ->: ("firstKey", jNumber(JsonNumberDouble(100))) ->: jEmptyObject                           |
    """[100,"secondValue"]"""                                     ! jArray(List(jNumber(JsonNumberDouble(100)), jString("secondValue")))                                                              |
    ...
    """"\/""""                                                    ! jString("/")                                                                                                          |
    """"\"""""                                                    ! jString("\"")                                                                                                         |
    "1"                                                           ! jNumber(JsonNumberDouble(1))                                                                                                      |
    "-1"                                                          ! jNumber(JsonNumberDouble(-1))                                                                                                     |
    "0"                                                           ! jNumber(JsonNumberDouble(0))                                                                                                      |
    "1E999"                                                       ! jNumber(JsonNumberDouble("1E999".toDouble))                                                                                       |
    "1E+999"                                                      ! jNumber(JsonNumberDouble("1E+999".toDouble))                                                                                      |
    "1E-999"                                                      ! jNumber(JsonNumberDouble("1E-999".toDouble))                                                                                      |
    "158699798998941697"                                          ! jNumber(JsonNumberDouble(158699798998941697D))
